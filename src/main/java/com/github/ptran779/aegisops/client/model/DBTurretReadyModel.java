...
public class DBTurretReadyModel extends Model {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(AegisOps.MOD_ID, "dbturret_ready_layer"), "main");
