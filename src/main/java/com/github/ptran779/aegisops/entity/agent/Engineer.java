...
import com.github.ptran779.aegisops.goal.special.WorkOnStructureGoal;
...
public class Engineer extends AbstractAgentEntity {
    private static AgentConfig config;
    public Engineer(EntityType<? extends AbstractAgentEntity> entityType, Level level) {
