...
import com.github.ptran779.aegisops.goal.special.ShieldBashGoal;
...
public class Heavy extends AbstractAgentEntity {
    private static AgentConfig config;
    public Heavy(EntityType<? extends AbstractAgentEntity> entityType, Level level) {
        super(entityType, level);
        this.agentType = "Heavy";
    }
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(2, new ShieldBashGoal(this, 60, 600));
        this.goalSelector.addGoal(3, new CustomRetaliationTargetGoal(this));
        this.goalSelector.addGoal(4, new CustomRangeTargetGoal<>(this, LivingEntity.class, 30, 24, 32, true, entity -> this.shouldTargetEntity(this, (LivingEntity) entity)));
        this.goalSelector.addGoal(3, new AgentAttackGoal(this, 4, 6, 24));
    }
